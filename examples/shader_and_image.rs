...
fn main() {
  ...
  let mut noise2d_shader =
    shader::Shader::new("assets/shader/thru.vert", "assets/shader/noise2D.frag").unwrap();
  ...
  'running: loop {
    ...
    unsafe {
      ...
      // noise
      noise2d_shader.update();
      noise2d_shader.begin();
      noise2d_shader.set_float(c_str!("iTime"), time);
      noise2d_shader.set_vec2(c_str!("iResolution"), res_x as f32, res_y as f32);
      test_mesh.draw();
